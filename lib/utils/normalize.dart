...
DateTime normalizeTglLahir(String text) {
  try {
    DateTime result = DateFormat('dd-MM-yyyy').parse(text);
    return result;
  } on FormatException {
    return DateTime.now();
  } catch (e) {
...
String normalizeTempatLahir(String text) {
  String result = text.toUpperCase();

  result = result
      .replaceAll('TEMPATTGL LAHIR ', '')
      .replaceAll('TEMPA/TG LAHIR ', '')
      .replaceAll('TEMPA/TGL LAHIR ', '')
      .replaceAll('TOMPA/TGL LAHIR ', '')
      .replaceAll('TEMPAT/TGL LAHIR ', '')
      .replaceAll('TEMPAT/TGL LAHIR', '')
      .replaceAll('TEMPAT/TG LAHIR ', '')
      .replaceAll('TEMPATG LAHIR ', '')
      .replaceAll('TEMPATTG LAHIR ', '')
      .replaceAll('TEMPATIG LAHIR ', '')
      .replaceAll('TEMPATO LAHIR ', '')
      .replaceAll('TEMPAT/TO LAHIR ', '')
      .replaceAll('TEMPATTG| LAHIR ', '')
      .replaceAll('TEMPATTG LAHIR', '')
      .replaceAll('TEMPATTD LAHIR ', '')
      .replaceAll('TEMPAVLG LAHIR ', '')
      .replaceAll('  ', ' ')
      .trim();
