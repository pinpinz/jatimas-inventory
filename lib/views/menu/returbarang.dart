...
class ScanRetur extends StatefulWidget {
  const ScanRetur({Key? key}) : super(key: key);

  @override
  _scanReturState createState() => _scanReturState();
}
...
class _scanReturState extends State<ScanRetur> {
  @override
  void initState() {
